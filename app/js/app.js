const $={};function noop(){}function _createModalFooter(e=[]){if(0===e.length)return document.createElement("div");const o=document.createElement("div");return o.classList.add("modal-footer"),e.forEach(e=>{const t=document.createElement("button");t.textContent=e.text,t.classList.add("btn"),t.classList.add(`btn-${e.type||"secondary"}`),t.onclick=e.handler||noop,o.appendChild(t)}),o}function _createModal(e){const t=document.createElement("div");t.classList.add("gmodal"),t.insertAdjacentHTML("afterbegin",`<div class="modal-overlay" data-close="true">
      ...
      </div>`);const o=_createModalFooter(e.footerButtons);return o.appendAfter(t.querySelector("[data-content]")),document.body.appendChild(t),t}Element.prototype.appendAfter=function(e){e.parentNode.insertBefore(this,e.nextSibling)},$.modal=function(e){const t=_createModal(e);let o=!1,i=!1;const n={open(){if(i)return console.log("modal is destroyed");o||t.classList.add("open")},close(){o=!0,t.classList.remove("open"),t.classList.add("hide"),setTimeout(()=>{t.classList.remove("hide"),o=!1,"function"==typeof e.onClose&&e.onClose()},200)}},r=e=>{e.target.dataset.close&&n.close()};return t.addEventListener("click",r),Object.assign(n,{destroy(){t.parentNode.removeChild(t),t.removeEventListener("click",r),i=!0},setContent(e){t.querySelector("[data-content]").innerHTML=e}})},$.confirm=function(i){return new Promise((e,t)=>{const o=$.modal({title:i.title,width:"400px",closable:!0,content:i.content,onClose(){o.destroy()},footerButtons:[{text:"Cancel",type:"secondary",handler(){o.close(),t()}},{text:"Delete",type:"danger",handler(){o.close(),e()}}]});setTimeout(()=>{o.open()},100)})};let rooms=[{id:1,title:"Living-room",price:13e3,img:"../src/img/light/Living-Room.jpg"},{id:2,title:"Dinnig-room",price:11e3,img:"../src/img/light/Dinnig-Room.jpg"},{id:2,title:"Dinnig-room",price:11e3,img:"../src/img/light/Dinnig-Room.jpg"},{id:2,title:"Dinnig-room",price:11e3,img:"../src/img/light/Dinnig-Room.jpg"},{id:2,title:"Dinnig-room",price:11e3,img:"../src/img/light/Dinnig-Room.jpg"},{id:2,title:"Dinnig-room",price:11e3,img:"../src/img/light/Dinnig-Room.jpg"},{id:2,title:"Dinnig-room",price:11e3,img:"../src/img/light/Dinnig-Room.jpg"},{id:2,title:"Dinnig-room",price:11e3,img:"../src/img/light/Dinnig-Room.jpg"},{id:3,title:"Second-Room",price:15e3,img:"../src/img/light/Second-Room.jpeg"}];const toHtml=e=>`
